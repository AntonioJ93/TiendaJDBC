...
public class VerCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ClienteDTO cDTO=(ClienteDTO) request.getSession().getAttribute("cliente");
        List<ArticuloCarritoDTO>listaCarrito=facade.listarCarrito(cDTO.getId());
        request.setAttribute("listaCarrito", listaCarrito);
        request.setAttribute("cliente", cDTO);
        request.getRequestDispatcher("./app/carrito.jsp").forward(request, response);
