...
public class GenerarInforme extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        InformeDTO iDTO=facade.informeUltimoPedido(cliente.getId());       
        request.setAttribute("informe", iDTO);
        request.getRequestDispatcher("./app/informePedido.jsp").forward(request, response);
