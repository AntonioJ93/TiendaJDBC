 ...
 * @author pryet
 */
@WebServlet(name = "EditarArticuloCarrito", urlPatterns = {"/editarArticuloCarrito"})
public class EditarArticuloCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("idEditar", idArticulo);
