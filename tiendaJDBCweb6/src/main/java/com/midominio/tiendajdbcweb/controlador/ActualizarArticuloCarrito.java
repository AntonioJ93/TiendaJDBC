 ...
 * @author pryet
 */
@WebServlet(name = "ActualizarArticuloCarrito", urlPatterns = {"/actualizarArticuloCarrito"})
public class ActualizarArticuloCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        facade.actualizarArticulo(cliente.getId(), idArticulo, cantidad);
