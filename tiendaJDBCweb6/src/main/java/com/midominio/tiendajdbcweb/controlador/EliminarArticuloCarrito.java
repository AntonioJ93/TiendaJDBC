 ...
 * @author Antonio
 */
@WebServlet(name = "EliminarArticuloCarrito", urlPatterns = {"/eliminarArticuloCarrito"})
public class EliminarArticuloCarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        facade.eliminarArticuloCarrito(cliente.getId(),idArticulo);
