...
@WebServlet(
        name = "PreArticulos",
        urlPatterns = {"/preArticulos"})
public class PreArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession(false) != null) {
            ClienteDTO cDTO = (ClienteDTO) request.getSession(false).getAttribute("cliente");
            request.setAttribute("cDTO", cDTO);
        }
            List<ArticuloDTO> articulos = facade.listarArticulos();
